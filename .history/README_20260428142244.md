...
* **Initial Sync** → builds the full document from scratch  
* **Incremental Sync** → updates only changed recipes  
...
Important:
Large changes (> 50 recipe updates per minute) should be handled by the initial daily full sync.  
