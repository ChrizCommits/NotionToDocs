...
When using Gemini for the first time, you'll be asked to connect your Google Workspace. After that, your document is automatically accessible.
...
*Using Gemini is optional — the sync works on its own.*
